  ...
  return (
    <>
      ...
      <div className="flex items-center gap-4">
        ...
        <p className=" bg-purple-500 text-black flex items-center justify-center w-7 h-7 text-[15px] px-3 py-1 rounded-full">D</p>
      </div>
    </div>
    <div className="flex items-center gap-2">
    <p className="bg-white text-black text-[15px] px-4 py-1 rounded-2xl">All</p>
